  ...
  <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#featured"><h1>Swiss Deli <span class="subhead">Philippines Inc.</span></h1></a>
      </div><!-- navbar-header -->
                                          ...
                                          <div class="pull-left col-lg-6">
                                              ...
                                              <table cellpadding="20px" style="width:100%">
                                                ...
                                                <tr>
                                                  ...
                                                  <td><input type="password" id="confirm_password" name="confirm_password" placeholder="Confirm Password" onfocusout = "passwordconfirm('password','confirm_password')"  required ></td>
                                                </tr>
                                                <tr>
