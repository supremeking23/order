                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content  ">
                            ...
                            <div class="modal-footer">
                                ...
                                <!--<button type="button" class="btn negate pull-left" data-dismiss="modal">Continue Shopping</button> -->
                        ...
                        exit(); 
                         ...
                         exit();
                          ...
                          if($total_grams_in_cart<30000){
                            echo "<script>alert('You  didnt acquire the minimum grams. Minimum grams should be 30000grams')</script>";
                         echo "<script>window.location='shop.php'</script>";
                         exit();
                          }else{
