                         ...
                         <tbody>
                            <tr>    
                                ...
                                <td><?php echo number_format( $order_details['product_price'] * $order_details['quantity'],2)?></td>
                                   ...
                                   <?php
                                       //$total_quantity = $order_details['quantity'] + $order_details['quantity'];
                                     } ?>
                            </tr>
                            ...
                            <tr>
                              <td></td>
                                <td></td>
                                <td>Total Grams: <?php echo $totalcountResult["grams"] *  $totalcountResult["sum(quantity)"];?> Grams</td>
                            ...
                            <tr> <td></td>
                                ...
                                <td colspan="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="confirm_order_pending.php?order_id=<?php echo $order_id;?>&customer_id=<?php echo $customer_id;?>&e_points=<?php echo $e_points;?>&subtotal=<?php echo $subtotal; ?>&total_na=<?php echo $totalna;?>" class="btn btn-warning">CONFIRM</a>&nbsp;&nbsp;<a href="cancel_order.php?order_id=<?php echo $order_id;?>&customer_id=<?php echo $customer_id;?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to cancel this order record?')">Cancel Order</a></td>
                                <td></td>
                            </tr>
