 ...
 <?php if(!isset($_GET['order_id'])){
        ...
        while($date = mysqli_fetch_assoc($run_date)){
            ...
            $date_cancelled = $date['date_cancelled'];
        }
        ...
        <div  class="container-fluid" style="background:">
            ...
            <div> <!-- former container-fluid-->
                ...
                <div class="row" style="margin-bottom: 50px">
                    ...
                    <?php $date_cancel = date_create($date_cancelled);
                            $cancel_date = date_format($date_cancel,'F d Y');
                        ?>
                    <h1 class="pull-left">Order Details</h1> <h3 class="pull-right">Date Canceled: <small><?php echo $cancel_date;?></small></h3>
                    <br />
