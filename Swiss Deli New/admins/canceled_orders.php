 ...
 <?php $get_cancel = get_all_canceled_orders();?>
        ...
        <div class="" style="margin-right: ;position: relative;bottom: -70px;right: -190px">
            ...
            <a href="orders.php?pending_orders=pending_orders&orders=orders" role="button" data-toggle="modal" class="btn  dashed_button" data-tooltip="tooltip" data-placement="top" data-original-title="" title="" id="">
                </i>&nbsp;Pending Order             
            </a>
            &nbsp; 
            ...
            <a href="delivered_orders.php?delivered_orders=delivered_orders&orders=orders" role="button" data-toggle="modal" class="btn  dashed_button" data-tooltip="tooltip" data-placement="top" data-original-title="" title="" id="">
             ...
             &nbsp; 
            <a href="canceled_orders.php?canceled_orders=canceled_orders&orders=orders" role="button" data-toggle="modal" class="btn <?php
            if (isset($_GET['canceled_orders']) =='canceled_orders' || isset($_GET['orders']) =='orders') {
                echo 'active_mini';
            }
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h3 class="modal-title text-primary" id="modalLabel">CANCELED ORDER LIST FILTRATION</h3>

                            </div>
                            <div class="modal-body ">
                                <center>

                                <form action="generate_cancelledorders_pdf.php" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                           ...
                           <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                     <?php while($pending = mysqli_fetch_assoc($get_cancel)) {?>
                                        <tr>    
                                            ...
                                            <td> <?php $date_cancelled =date_create($pending['date_cancelled']);
                                                    echo date_format($date_cancelled,"F d Y g:i:s A");
                                            ?></td>  
                                            <td><a href="order_details_cancel.php?customer_id=<?php echo urlencode($pending["customer_id"]); ?>&orders=orders&order_id=<?php echo $pending['order_id']?>" data-tooltip="tooltip" data-placement="top" data-original-title="View Order Deteails" title=""  class="btn btn-primary btn-sm">View Details</i></a></td>  
